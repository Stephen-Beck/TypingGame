...
namespace TypingGame.Core.Engine {
    ...
    public static class MetricsCalculator {
        ...
        public static double NetWPM(int totalChars, int totalErrors, int submissions, double elapsedSeconds) {
            ...
            // Do not allow negative WPM (possible due to totalErrors)
            return Math.Max(0,(totalChars + submissions - totalErrors) / 5 / (elapsedSeconds / 60));
        }
        ...
        public static int CountErrors(string input, string phrase) {
            ...
            This algorithm compares two strings and counts how many "edits" (insert, delete, substitute) it would take to change one string into the other.
            */
